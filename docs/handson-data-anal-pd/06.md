...
*   *(Pandas)与 SQL 的比较*:[https://Pandas . pydata . org/Pandas-docs/stable/getting _ started/Comparison/Comparison _ with _ SQL . html](https://pandas.pydata.org/pandas-docs/stable/getting_started/comparison/comparison_with_sql.html)
