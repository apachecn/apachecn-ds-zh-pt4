<title>C15019_01_Final_ePub_SW</title> <link href="css/epub.css" rel="stylesheet" type="text/css">
...
数据可以来自不同的数据源:例如，可能有平面文件、数据存储或应用程序编程接口(API)提要。在本书中，我们将使用平面文件，如 CSV、Excel 电子表格或 JSON。所有这些类型的文件都以自己的格式和结构存储信息。
