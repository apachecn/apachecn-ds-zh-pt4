<title>B16834_08_Final_SK_ePub</title> <link href="css/style-JRserifv3.css" rel="stylesheet" type="text/css">
...
现在，让我们用它来计算一些衡量我们绩效的指标。一个常见的指标是**假阳性率** ( **FPR** )，它告诉我们**假警报率**。它是通过计算假阳性与实际阴性的之比得出的:
...
*   *分类精度不够:可以使用更多的绩效衡量指标*:[https://machine learning mastery . com/Classification-Accuracy-Is-Not-success-More-Performance-Measures-You-Can-Use/](https://machinelearningmastery.com/classification-accuracy-is-not-enough-more-performance-measures-you-can-use/)
