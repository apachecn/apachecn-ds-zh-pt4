<title>Working with Analytical Data on Jupyter</title>  <link href="../stylesheet.css" rel="stylesheet" type="text/css"> <link href="../page_styles.css" rel="stylesheet" type="text/css">
...
<title>Data scraping with a Python notebook</title>  <link href="../stylesheet.css" rel="stylesheet" type="text/css"> <link href="../page_styles.css" rel="stylesheet" type="text/css">
...
![](../images/00026.jpeg)<title>Using heavy-duty data processing functions in Jupyter</title>  <link href="../stylesheet.css" rel="stylesheet" type="text/css"> <link href="../page_styles.css" rel="stylesheet" type="text/css">

# 在 Jupyter 中使用重型数据处理功能

Python 有几组处理函数，会消耗计算机系统的能力。让我们在 Jupyter 中使用其中一些，并确定功能是否如预期的那样执行。

<title>Using NumPy functions in Jupyter</title>  <link href="../stylesheet.css" rel="stylesheet" type="text/css"> <link href="../page_styles.css" rel="stylesheet" type="text/css">
...
![](../images/00028.jpeg)<title>Using pandas in Jupyter</title>  <link href="../stylesheet.css" rel="stylesheet" type="text/css"> <link href="../page_styles.css" rel="stylesheet" type="text/css">
...
<title>Use pandas to read text files in Jupyter</title>  <link href="../stylesheet.css" rel="stylesheet" type="text/css"> <link href="../page_styles.css" rel="stylesheet" type="text/css">

# 在 jupiter 中使用熊猫阅读文本文件
...
然而，同样像许多熊猫一样，有一组广泛的可选参数可以传递给`read_csv`函数，这些参数默认为最常用的特性，因此我们可以像以前一样编写小代码来完成我们的工作。我们可以使用的一些附加参数允许我们:
...
![](../images/00029.jpeg)<title>Use pandas to read Excel files in Jupyter</title>  <link href="../stylesheet.css" rel="stylesheet" type="text/css"> <link href="../page_styles.css" rel="stylesheet" type="text/css">

# 用熊猫在 jupiter 中读取 excel 文件
...
木星下的合成气流如下。数据集看起来与之前读入的 CSV 文件非常相似。

![](../images/00030.jpeg)<title>Using pandas to work with data frames</title>  <link href="../stylesheet.css" rel="stylesheet" type="text/css"> <link href="../page_styles.css" rel="stylesheet" type="text/css">

# 使用 pandas 处理数据框

一旦我们有了可用的数据框架，就有几只熊猫可以进一步处理数据。我们将通过观察熊猫来:

*   `groupby`功能
*   操纵列
*   计算异常值

<title>Using the groupby function in a data frame</title>  <link href="../stylesheet.css" rel="stylesheet" type="text/css"> <link href="../page_styles.css" rel="stylesheet" type="text/css">
...
![](../images/00031.jpeg)<title>Manipulating columns in a data frame</title>  <link href="../stylesheet.css" rel="stylesheet" type="text/css"> <link href="../page_styles.css" rel="stylesheet" type="text/css">
...
![](../images/00032.jpeg)<title>Calculating outliers in a data frame</title>  <link href="../stylesheet.css" rel="stylesheet" type="text/css"> <link href="../page_styles.css" rel="stylesheet" type="text/css">
...
<title>Using SciPy in Jupyter</title>  <link href="../stylesheet.css" rel="stylesheet" type="text/css"> <link href="../page_styles.css" rel="stylesheet" type="text/css">
...
<title>Using SciPy integration in Jupyter</title>  <link href="../stylesheet.css" rel="stylesheet" type="text/css"> <link href="../page_styles.css" rel="stylesheet" type="text/css">
...
<title>Using SciPy optimization in Jupyter</title>  <link href="../stylesheet.css" rel="stylesheet" type="text/css"> <link href="../page_styles.css" rel="stylesheet" type="text/css">
...
![](../images/00037.jpeg)<title>Using SciPy interpolation in Jupyter</title>  <link href="../stylesheet.css" rel="stylesheet" type="text/css"> <link href="../page_styles.css" rel="stylesheet" type="text/css">
...
![](../images/00039.jpeg)<title>Using SciPy Fourier Transforms in Jupyter</title>  <link href="../stylesheet.css" rel="stylesheet" type="text/css"> <link href="../page_styles.css" rel="stylesheet" type="text/css">
...
<title>Using SciPy linear algebra in Jupyter</title>  <link href="../stylesheet.css" rel="stylesheet" type="text/css"> <link href="../page_styles.css" rel="stylesheet" type="text/css">
...
<title>Expanding on panda data frames in Jupyter</title>  <link href="../stylesheet.css" rel="stylesheet" type="text/css"> <link href="../page_styles.css" rel="stylesheet" type="text/css">
...
<title>Sorting and filtering data frames in Jupyter/IPython</title>  <link href="../stylesheet.css" rel="stylesheet" type="text/css"> <link href="../page_styles.css" rel="stylesheet" type="text/css">

# 在 Jupyter/IPython 中排序和过滤数据帧

数据框允许您使用数据框本身的现有功能，自动轻松地对所涉及的数据集进行排序和过滤。

<title>Filtering a data frame</title>  <link href="../stylesheet.css" rel="stylesheet" type="text/css"> <link href="../page_styles.css" rel="stylesheet" type="text/css">
...
<title>Sorting a data frame</title>  <link href="../stylesheet.css" rel="stylesheet" type="text/css"> <link href="../page_styles.css" rel="stylesheet" type="text/css">
...
在本章中，我们看了一些可能在 Jupyter 中执行的计算密集型任务。我们使用 Python 抓取了一个网站来收集数据进行分析。我们使用 Python NumPy、pandas 和 SciPy 函数对结果进行深入计算。我们进一步研究了熊猫，探索了操纵数据帧的方法。最后，我们看到了排序和过滤数据帧的例子。
