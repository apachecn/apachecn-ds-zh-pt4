    ...
    *Sweave:由 *Friedrich Leisch* 开发的使用文化数据分析的动态生成统计报告*。*计算统计学学报*作者*Wolfgang hrdle*和*Bernd ronz*，编辑，Compstat 2002，第 575-580 页。物理出版社，海德堡，2002 年。国际标准书号 3-7908-1517-9。
    ...
    1.  首先，用`knitr`语法创建一个基本代码块:
        ...
        试映
         ...
         &#124;
        &#124; --- &#124; --- &#124;
        &#124; ````py{r}``# code block``a <- 3``b <- 2``a + b`````` &#124; ![How to do it…](img/B04007_08_14.jpg)`# code block` &#124;
    ...
    2.  我们可以通过设置`echo=FALSE`:
        ...
        试映
         ...
         &#124;
        &#124; --- &#124; --- &#124;
        &#124; ````py{r, echo=FALSE}``# code block``a <- 3``b <- 2``a + b`````` &#124; ![How to do it…](img/B04007_08_15.jpg)`# code block` &#124;
    ...
    3.  或者，我们可以通过设置`eval=FALSE`:
        ...
        试映
         ...
         &#124;
        &#124; --- &#124; --- &#124;
        &#124; ````py{r, eval=FALSE}``# code block``a <- 3``b <- 2``a + b`````` &#124; ![How to do it…](img/B04007_08_16.jpg)`# code block` &#124;
    ...
    6.  接下来，我们可以在减价报告中用给定的图形宽度和高度呈现一个图形:
        ...
        试映
         ...
         &#124;
        &#124; --- &#124; --- &#124;
        &#124; ````py{r, fig.width=6, fig.height=4}``data(iris)``plot(iris)`````` &#124; ![How to do it…](img/B04007_08_17.jpg)`plot(iris)` &#124;
    ...
    7.  我们可以通过设置`warning=FALSE`:
        ...
        T17 &#124; 试映 &#124;
        &#124; --- &#124; --- &#124;
        &#124; ````py{r, fig.width=6, fig.height=4,warning=FALSE}``library(ggplot2)``g <- ggplot(data=iris, mapping=aes(x=Sepal.Length, y=Sepal.Width, colour=Species))``print(g + geom_point())`````` &#124; ![How to do it…](img/B04007_08_18.jpg)`library(ggplot2)` &#124;
