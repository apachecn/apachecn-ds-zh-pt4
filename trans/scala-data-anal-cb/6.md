...
5.  **在 Kafka** 中确认接收:我们可以使用 Kafka 暴露的JMX mbean 来确认数据是否在 Kafka 中。我们将使用 JConsole UI 来探索 MBeans。正如您所看到的，消息的数量是 **24849** ，这与 ElasticSearch 文档的数量相匹配(在之前的菜谱中已经公布)。![How to do it...](img/InsertImage_B03812_07_06.jpg)
