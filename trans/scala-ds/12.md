...
这里， *params* 为参数向量，![Regularization in logistic regression](img/4795_12_09.jpg)为第*I个训练样本的特征向量，如果第*I*第*个训练样本为垃圾，则![Regularization in logistic regression](img/4795_12_11.jpg)为 *1* ，否则为 *0* 。这与第 2 章[中介绍的逻辑回归成本函数完全相同，除了增加了正则化项![Regularization in logistic regression](img/4795_12_12.jpg)，参数向量的![Regularization in logistic regression](img/4795_12_13.jpg)范数。 *n* 最常见的值是 2，在这种情况下![Regularization in logistic regression](img/4795_12_14.jpg)就是参数向量的大小:](ch02.html "Chapter 2. Manipulating Data with Breeze")
